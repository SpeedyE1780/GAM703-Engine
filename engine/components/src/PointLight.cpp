...
{
	PointLight::PointLight(core_interface::ITransform* transform, float range, const glm::vec3& color, float intensity) :
	...
	{
		return new PointLight(m_transform, m_range, m_color, m_intensity);
	}
