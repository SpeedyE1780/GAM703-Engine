...
namespace gam703::engine::components
{
	...
	{
	public:
		SpotLight(core_interface::ITransform* transform, const glm::vec3& color, float innerAngle = 25.0f, float outerAngle = 45.0f, float range = 5.0f, float intensity = 1.0f);
